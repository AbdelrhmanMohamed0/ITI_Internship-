...
#define TIMER_CONFIG_H_
	...
	#define TIMER0_PRESCALER		TIMER_DIVISION_FACTOR_8
		 ...
		 * 2. TIMER_CLR_ON_CTC_up_count_SET_ON_down_count
		 * 3. TIMER_SET_ON_CTC_up_count_CLR_ON_down_count
		 */
...
/***********************************************************************************************/
	...
	/*Set CTCA Value*/
	#define TIMER1_CTCA_VAL						400         //duty

	/*Set CTCB Value*/
	#define TIMER1_CTCB_VAL						0

	/*Set Input Capture Value*/
	#define TIMER1_ICR1_VAL						999        //freq
...
/***********************************************************************************************/
	...
	#define TIMER2_PRESCALER		TIMER_DIVISION_FACTOR_8
		 ...
		 * 3. TIMER_SET_ON_CTC_up_count_CLR_ON_down_count
		 */
		#define TIMER2_CTC_PWM_MODE						TIMER_CLR_ON_CTC_up_count_SET_ON_down_count
